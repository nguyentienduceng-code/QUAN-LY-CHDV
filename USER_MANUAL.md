...
Hệ thống cấp cho mỗi khách thuê một tài khoản riêng để họ có thể:
- Đăng nhập bằng Email đã đăng ký với chủ nhà.
- Xem chi tiết **Hợp đồng đang thuê** (Ngày hết hạn, Tiền cọc).
- Theo dõi **Hóa đơn hàng tháng** và tình trạng thanh toán.
- Gửi **Yêu cầu bảo trì/sửa chữa** trực tiếp cho ban quản lý thông qua ứng dụng, kèm theo mô tả chi tiết. Ban quản lý sẽ nhận được thông báo ở tab Bảo Trì.

---

## ❓ 6. Câu Hỏi Thường Gặp (FAQ) & Hỗ Trợ

**Q1: Dữ liệu của tôi có bị mất khi tắt máy tính không?**
- Hoàn toàn không. RentFlow sử dụng công nghệ Cloud Database (Firebase) theo chuẩn bảo mật toàn cầu. Dữ liệu được đồng bộ hóa theo thời gian thực (Real-time). Nếu máy tính của bạn hỏng, chỉ cần đăng nhập tài khoản trên thiết bị khác là dữ liệu vẫn còn nguyên.

**Q2: Làm sao để chuyển dữ liệu cũ từ Excel sang phần mềm?**
- Bạn có thể sử dụng nút **Nhập Dữ Liệu (Import)** ở trang Tổng quan. Tải file mẫu của hệ thống về, điền dữ liệu cũ theo cột tương ứng rồi tải ngược lên lại.

**Q3: Tôi có nhiều tòa nhà cách xa nhau, có quản lý chung được không?**
- Được. Ở phần `Cấu hình`, bạn hãy thêm tên tất cả các Tòa nhà. Sau đó khi tạo phòng, bạn chỉ cần gán phòng đó thuộc Tòa nhà nào. Hệ thống tự động phân loại rành mạch.
